    ...
    style="width: 100%">
     <el-table-column type="selection" width="50"></el-table-column>
        ...
        <el-table-column prop="name" label="NICKNAME"  width="120">  </el-table-column>
         <el-table-column prop="role_Name" label="ROLE"  width="120">  </el-table-column>
 ...
 <el-button size="medium" type="danger" icon="el-icon-delete" @click="removeMore">Delete All</el-button>
      ...
      <el-drawer
       ...
       <h2 class="title">UserInfo</h2>
          ...
          >
            <el-radio v-model="userForm.role_Name" label="MVO">Brand-seller</el-radio>
            <el-radio v-model="userForm.role_Name" label="BVO">Borrow-seller</el-radio>
          </el-form-item>
      ...
      this.$message.success("Delete success");
        ...
        updateUserInfo(){
           ...
           let tmp;
            ...
            if(this.userForm.role_Name=="MVO"){
              tmp = "2";
            }
            if(this.userForm.role_Name=="BVO"){
              tmp = "3";
            }
            // this.userForm 
            ...
            roleId:tmp,
            role_Name:this.userForm.role_Name,
          }).then(res => {
                console.log(res)
              let resdata=res.data;
