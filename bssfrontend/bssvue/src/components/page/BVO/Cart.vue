...
<div class="block">
  ...
  <div>
    ...
    <div>
      ...
      class="table-check" @selection-change="handleSelectionChange" height="850" >
      <el-table-column prop="cartId" label="Cart id" style="width: 40px;"></el-table-column>
      ...
      <el-table-column prop="quantity" label="Req. Quantity"></el-table-column>
      <el-table-column prop="proStatus.statusName" label="Req. Status"></el-table-column>
