<template>
                ...
                <el-menu
                    ...
                    class="el-menu-vertical-demo navDiv transbackcolor"
                    router
                    @open="handleOpen"
                    @close="handleClose"
                ...
                >
                <!-- got submenu -->
                <template v-for="item in items" class="transbackcolor" >
                    <template v-if="item.subMenuList!=undefined && item.subMenuList.length>0" class="transbackcolor" >
                        <el-submenu class="transbackcolor" :index="item.menuUrl" :key="item.menuUrl"  >
                        <template #title class="transbackcolor" >
                        ...
                        <el-menu-item  class="transbackcolor"
                    ...
                    <!--  not got submenu -->
                    <template v-else class="transbackcolor">
                    <el-menu-item :index="item.menuUrl" :key="item.menuUrl"  class="transbackcolor">
                        <i :class="item.menuIcon"></i>
