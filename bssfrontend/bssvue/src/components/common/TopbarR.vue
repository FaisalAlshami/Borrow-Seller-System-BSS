...
<div class="topbar-container">
    ...
    <div class="logo">
       <!--     <el-avatar :src="logoimg" style="width:300px; height:50px; margin-top:3px;"></el-avatar>   -->
       <span style="color:white;">Borrow<span style="color:red;">-</span>Seller <span style="color:red;">Platform</span></span>
